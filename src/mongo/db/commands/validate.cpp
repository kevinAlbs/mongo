...
public:
    ...
    bool run(OperationContext* opCtx,
        ...
        */
        ...
        // Skip checking UUID on local database for shard secondaries until SERVER-32255 is resolved.
        bool isShardServer = serverGlobalParams.clusterRole == ClusterRole::ShardServer;
        auto replCoord = repl::ReplicationCoordinator::get(opCtx);
        bool isReplSet = replCoord->getReplicationMode() == repl::ReplicationCoordinator::modeReplSet;
        bool isPrimary = isReplSet ? replCoord->getMemberState() == repl::MemberState::RS_PRIMARY : false;
